...
export default function SubjectPage({
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12 animate-fade-in">
      ...
      <div className={`relative overflow-hidden rounded-2xl bg-gradient-to-br ${c.from} ${c.to} shadow-md mb-8`}>
        {/* Brain watermark */}
      ...
      {topics.length === 0 ? (
        <div className="text-center py-20">
          <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${c.from} ${c.to} flex items-center justify-center mx-auto mb-4 shadow-md`}>
