...
export default function QuizPage({ noteId, noteTitle, notes, onBack, yearLevel }) {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 animate-fade-in">
      ...
      <div className="bg-white rounded-2xl border border-ink-200 p-6 mb-4 animate-slide-up" key={current}>
...
function ResultsScreen({ questions, answers, earnedMarks, totalMarks, pct, onRetry, onBack, noteTitle }) {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 animate-fade-in">
      ...
      <div className="bg-white rounded-2xl border border-ink-200 p-8 text-center mb-6">
        <div className="w-16 h-16 rounded-2xl bg-ink-900 flex items-center justify-center mx-auto mb-4">
          <Trophy className="w-8 h-8 text-white" />
        </div>
        <h1 className="font-display text-2xl font-700 text-ink-900 mb-1">{noteTitle}</h1>
        ...
        <div className="grid grid-cols-3 gap-3 mt-6 text-center">
          {[
            ...
            <div key={stat.label} className="bg-ink-100/60 rounded-xl py-3">
