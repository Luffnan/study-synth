        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { icon: <Youtube className="w-6 h-6 text-red-600" />, bg: 'bg-red-50 border-red-200', label: 'YouTube Videos', sub: 'Documentaries, subject explainers, lectures and crash courses' },
