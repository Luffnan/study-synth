  ...
  return (
    <div className="min-h-screen bg-ink-50">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 pt-12 pb-10 text-center">
        ...
        <div className="inline-flex items-center gap-0 bg-accent-yellow text-ink-900 text-sm font-600 px-5 py-0.5 rounded-full mb-6 border border-ink-900">
          <img src="/fork.png" alt="fork" className="w-8 h-8" />
