  ...
  return (
    <div className="max-w-lg mx-auto px-4 sm:px-6 py-6 sm:py-10 animate-fade-in">
      ...
      <div className="text-center mb-6">
        ...
        <h1 className="font-display text-2xl sm:text-3xl font-700 text-ink-900 leading-tight mb-1.5">
          Create study notes
        </h1>
...
function ProcessingPanel() {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 text-center animate-fade-in">
      ...
      <h2 className="font-display text-xl font-700 text-ink-900 mb-2">Generating your notes</h2>
